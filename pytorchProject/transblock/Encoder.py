...
from trans1utils.Get_attn_pad_mask import get_attn_pad_mask
from trans1utils.PosWiseFeedForwardNet import PosWiseFeedForwardNet
from trans1utils.MultiHeadAttention import MultiHeadAttention
...
class Encoder(nn.Module):
    ...
    def forward(self, enc_inputs):
        ...
        for layer in self.layers:
            ...
            enc_outputs, enc_self_attention = layer(enc_inputs, mask_matrix)
